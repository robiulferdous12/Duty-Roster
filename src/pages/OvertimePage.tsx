                ...
                <tbody>
                  {filteredOvertimeList.map((ot, idx) => (
                    <tr key={ot.id} className="border-b border-slate-100/80 hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="px-4 py-1 text-slate-700 font-medium">{formatDateToDMY(ot.date)}</td>
                      <td className="px-4 py-1 text-slate-600 font-mono">{formatTimeTo12H(ot.from)}</td>
                      <td className="px-4 py-1 text-slate-600 font-mono">{formatTimeTo12H(ot.to)}</td>
                      <td className="px-4 py-1 text-slate-800 font-bold">{ot.totalHours}h</td>
